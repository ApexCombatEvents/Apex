  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-[1fr,auto,1fr] gap-5 sm:gap-6 items-center">
        ...
        {/* MIDDLE - Bout Details */}
        <div className="flex flex-col items-center text-center text-sm text-slate-600 px-3 sm:px-5 py-2 sm:py-0 bg-slate-100 sm:bg-transparent rounded-lg sm:rounded-none">
